...
const popularsales = {
  ...
  items: [
    ...
    },
    {
      ...
      sizes: [40, 41, 42, 43], // Add sizes here
    },
    {
      id: "0p0x1",
...
const footerAPI = {
  titles: [ {title: "About BestOfficiel"},{title: "Our Support"},{title: ""} ],
  links: [
    [
      {link: "100% original"},
